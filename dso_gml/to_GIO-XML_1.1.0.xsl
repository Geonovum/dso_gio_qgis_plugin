...
<xsl:stylesheet 
    ...
    <xsl:param name="schemalocation" select="'https://standaarden.overheid.nl/lvbb/stop/aanlevering https://standaarden.overheid.nl/lvbb/1.1.0/lvbb-stop-aanlevering.xsd'"/>
